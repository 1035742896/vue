  ...
  <div class="food-img">
    ...
    <el-form ref="loginForm" :model="form" :rules="rules" label-width="80px" class="login-box">
      ...
      <el-form-item label="验证码" prop="code" class="form-item">
        <el-input prefix-icon="el-icon-chat-dot-round"  type="code" placeholder="请输入验证码" clearable v-model="form.code" class="input-code"/>
    ...
    <el-dialog title="重置密码" :visible.sync="dialogFormVisible" width="45%"
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
	  ...
	  console.log('验证验证码' + this.form.code + '--' + this.verifyCode)
